...
# Publish Writing NFT with an article URL by LikeCoin app

{% hint style="danger" %}
Archived on 2024/08/14. Information is out of date.
{% endhint %}
...
If the article is not registered with an [ISCN](../../../depub/what-is-iscn/), please directly enter the article URL into the blank space and click "Register ISCN".
...
**If you want your work to have detailed metadata, please** [**register an ISCN**](../../../depub/what-is-iscn/app.like.co/) **and** [**publish Writing NFT with the ISCN ID**](../../../depub/nft-portal/iscn-id.md)**.**
{% endhint %}
