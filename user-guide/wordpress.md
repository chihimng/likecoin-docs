...
* After minting Writing NFT, a [NFT Widget](../depub/collect-writing-nft/nft-widget.md) is automatically embedded at the bottom of each post for readers to [collect Writing NFT](../depub/collect-writing-nft/) and Integrate [LikeCoin button](creator/).
...
[At WordCamp Asia 2023, Web3Press made its grand debut | LikeCoin Update](https://blog.like.co/en/web3press-at-wordcamp-asia-2023/)
...
You can also check your creations on the Liker Land [My Dashboard](../archive/archive/liker-land/dashboard.md).
